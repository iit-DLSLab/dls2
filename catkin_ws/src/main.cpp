...
int main(int argc, char **argv)
{
	...
	if(Options::show_docs)
	{
		return system
		(
			"/usr/bin/dls2/scripts/xdg-open "
			"/usr/local/share/doc/dls2/html/index.html"
		);
	}
