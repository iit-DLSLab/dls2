...
# $dls_messaging.  The library is automatically installed to the
...
#       the target dls_messaging.
#    2. Link them to dls_messaging
#    3. Add to the include path dls_msg_includes
#
# TODO implement this
...
function(dls_add_message msg)
	...
	if(NOT TARGET dls_messaging)
		add_library(dls_messaging SHARED)
		target_compile_options(dls_messaging
			PRIVATE
			-w # Suppress all warnings, this library's code is auto-generated
		)
		target_include_directories(dls_messaging
			PUBLIC
			${CMAKE_CURRENT_BINARY_DIR}/gen/include
		)
		install(
			TARGETS dls_messaging
			LIBRARY
				DESTINATION ${DLS_INSTALL_MESSAGES_DIR}
				COMPONENT dls_messaging
		)
		target_include_directories(dls_messaging
			PUBLIC
			${CMAKE_CURRENT_BINARY_DIR}/gen/include
