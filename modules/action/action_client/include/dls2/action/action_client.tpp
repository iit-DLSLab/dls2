...
namespace dls
{
	...
	// template <typename GOAL_t, typename FEEDBACK_t, typename RESULT_t>
	// RESULT_t ActionClient<GOAL_t, FEEDBACK_t, RESULT_t>::callAction(const GOAL_t& goal)
	// {
	// 	// {
	// 	// 	std::lock_guard<std::mutex> lock(this->action_mutex);
	...
	// 	// this->sendGoal(goal);
	// 	// RESULT_t result = this->waitForResult();
	// 	// // std::cout << "Call unloadAction\n";
	// 	// // std::this_thread::sleep_for(std::chrono::milliseconds(1000));
	// 	// command_manager->callCommand("unloadAction", {action_name}, "ServiceLayer");
	// 	// std::cout << "Call unloadAction END\n";
	// 	std::cout << "TODO- wait for the result\n";
	// 	RESULT_t result;
	// 	return result;
	// }
