...
namespace dls
{
	...
	public:
        ...
        //LEG ODOMETRY POSE
        robotlib::LimbDataMap<Eigen::Vector3d> position_legs_;
        robotlib::LimbDataMap<Eigen::Quaterniond> orientation_legs_;

        //LEG ODOMETRY VELOCITY
        robotlib::LimbDataMap<Eigen::Vector3d> linear_velocity_legs_;
        robotlib::LimbDataMap<Eigen::Vector3d> angular_velocity_legs_;

        //LEG ODOMETRY ERROR
        robotlib::LimbDataMap<Eigen::Vector3d> linear_velocity_error_legs_;
        robotlib::LimbDataMap<Eigen::Vector3d> angular_velocity_error_legs_;
    private:
