...
namespace dls
{
	 ...
	 */
	class GoFoldServer : public ActionServerBase<actions_msg_wrappers::goFold::GOAL_t, actions_msg_wrappers::goFold::FEEDBACK_t, actions_msg_wrappers::goFold::RESULT_t>
	{
	public:
		/*! @brief Constructor
