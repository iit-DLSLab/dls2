...
LegOdometryDebug::LegOdometryDebug(const std::shared_ptr<robotlib::RobotBase> pRobot)
    ...
    , orientation_legs((pRobot->makeLegDataMap<Eigen::Quaterniond>(Eigen::Quaterniond(1.0, 0.0, 0.0, 0.0))))
