...
Attitude::Attitude()
	: frame_id_(""), sequence_id_(0), timestamp_(0.0), orientation_(Eigen::Quaterniond::Identity()), orient_t265_(Eigen::Quaterniond::Identity()), angular_velocity_(Eigen::Vector3d::Zero()), euler_angles_t265_(Eigen::Vector3d::Zero()), euler_angles_estimation_(Eigen::Vector3d::Zero())
{
}

Attitude::Attitude(Attitude &attitude)
	: frame_id_(attitude.frame_id_), sequence_id_(attitude.sequence_id_), timestamp_(attitude.timestamp_), orientation_(attitude.orientation_), orient_t265_(attitude.orient_t265_), angular_velocity_(attitude.angular_velocity_), euler_angles_t265_(attitude.euler_angles_t265_), euler_angles_estimation_(attitude.euler_angles_estimation_)
{
}
...
void Attitude::setDataFromWrapperBase(WrapperBase *wrapper_base)
{
	// Assuming wrapper is of type Wrapper<MsgType>
	*this = static_cast<Attitude &>(*wrapper_base);
}