...
using TypeIntrospectionNumericStruct = std::vector<dls::NumericDatum>;
using TypeIntrospectionStringStruct = std::vector<dls::TextDatum>;
...
void get_introspection_type_names(
        ...
        const std::vector<eprosima::fastrtps::types::MemberId>& current_members_tree = {},
        const std::vector<eprosima::fastrtps::types::TypeKind>& current_kinds_tree = {},
